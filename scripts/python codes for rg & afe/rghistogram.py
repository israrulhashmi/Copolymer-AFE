...
num_bins = 10  # Half of the original number of bins
bin_width = 0.32  # Adjust the width as needed to achieve the desired distances
...
plt.xticks([3, 4, 5, 6], ['3', '4', '5', '6'], fontsize=18)

# Specify the positions and labels for the y-axis
plt.yticks([0, 2000,  4000,6000], [ '0','2000',  '4000','6000'], fontsize=18)
ax = plt.gca()
